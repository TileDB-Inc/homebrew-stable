...
The latest stable verison of [TileDB v1.7.1](https://github.com/TileDB-Inc/TileDB/releases/tag/1.7.1)
...
```
TileDB/homebrew-stable [release-1.7.1●] » brew info tiledb

tiledb: stable 1.7.1, HEAD
Storage management library for sparse and dense array data
http://tiledb.io
/usr/local/Cellar/tiledb/1.7.1 (39 files, 4.0MB) *
